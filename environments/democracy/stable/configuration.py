...
try:
    from environments.random.configuration import CognitiveResourceConfig as OriginalCognitiveResourceConfig
except ImportError:
...
try:
    from environments.random.configuration import MarketConfig
except ImportError:
    @dataclass(frozen=True)
...
class ParticipationConfig:
    ...
    delegate_participation_rate: float = 1.00
    voter_participation_rate: float = 1.00
