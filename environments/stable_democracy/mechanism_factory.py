...
from environments.noise_democracy.mechanism_factory import (
...
from environments.stable_democracy.voting_aggregation import _portfolio_vote_aggregator_stable # NEWLY CREATED
