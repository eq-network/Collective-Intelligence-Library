...
from environments.noise_democracy.configuration import create_thesis_baseline_config, create_thesis_highvariance_config
...
def define_all_experiments() -> List[ExperimentDefinition]:
    ...
    competitive_openai_exp = ExperimentDefinition(
        ...
        adversarial_proportions_to_sweep=[0.4, 0.5, 0.55, 0.6, 0.65, 0.7, 0.8],
